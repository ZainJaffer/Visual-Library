...
SECRET_KEY = 'django-insecure-181i*$3s!7e3v#!i%k&6pb##pvrn^w_vv%(+*=id@bmeg*dyw$'
...
WSGI_APPLICATION = 'visual_library.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'visual_library'),
